...
; El tama�o del rubber-spot es regulable.
...
; !!!! El tama�o de la caja de trabajo se puede MODIFICAR POR EDITOR!!!!!!
...
;      [RUBW=rubw] = tama�o del rubber-spot que se asume de entrada. Se
...
sizbx0=200  &  sizby0=200  ;tama�o de la de trabajo a extraer
...
;Dados el 1� y 4� cuadrantes de una funcion par, reconstruye
;la informacion en el 2� y 3er cuadrantes.
;
;INPUT:
;    f_half = imagen con 1� y 4� cuadrantes, de dimension
...
;Extracts 1� y 4� quadrants of the power.
powhalf=pows(x0:*,*)
