...
for i in range (0, len(input_list)):
    ...
    save_name = '/home/prabhu/sunrise_holly/binned_cycles/imax_lp_max_' + input_list[i].split('_')[-2]
    save_angs = '/home/prabhu/sunrise_holly/binned_cycles/imax_roat_angle_Q_U_' + input_list[i].split('_')[-2] 
